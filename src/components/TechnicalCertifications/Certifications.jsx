 ...
 * @description Certifications component for the portfolio website. This section showcases professional certifications with an interactive scroll experience. As the user scrolls through the section, different certifications are highlighted, and corresponding images are displayed with a 3D tilt effect on hover. The component uses GSAP for scroll-triggered animations and interactivity, creating an engaging way to present the portfolio owner's qualifications and achievements.
    ...
    <section className="section pin-section" id="certification" ref={sectionRef}>
      ...
      <div className="content">
        <ul className="certification-list">
          <li>ITI - Frontend & Cross-Platform track</li>
          <li>NCW - Front-End Web Development Sprints </li>
        </ul>
        ...
        <div className="right">
          <div className="slide center">
            <img src="/assets/images/certificates/iti.jpg" alt="" />
          </div>
          <div className="slide center">
